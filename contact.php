...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Contact@PASS</title>
		<link rel="stylesheet" style="text/css" href="webstyle.css">
	</head>	
	...
	height="100" width="100">
		...
		<nav class="topnav">
				...
				<li><a class="topactive" href="contact.php">Contact</a></li>
			</ul>
		</nav>
...
?>
		...
		<main>
			<section>
			<header>
				<h2 class="sectionhd">Contact Us</h2>
			</header>
